            ...
            <div key={item.id} className="cart-item">
                ...
                <div className="cart-item-right-info">
                    ...
                    <div className="quantity-control">
                        ...
                        <svg className="cart-delete-button" width="800px" height="800px" viewBox="-2 0 24 24" id="meteor-icon-kit__regular-trash" fill="none" xmlns="http://www.w3.org/2000/svg">
